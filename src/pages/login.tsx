    ...
    <main className="container mx-auto px-8">
      ...
      <form className="max-w-sm mx-auto" onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          <input type="email" id="email" name="email" className="w-full px-4 py-2 border border-gray-300 rounded-md" value="adamgrayscale@gmail.com"/>
        </div>
        <div className="mb-4">
          <label htmlFor="password" className="block mb-2">Password:</label>
          <input type="password" id="password" name="password" className="w-full px-4 py-2 border border-gray-300 rounded-md" value="password"/>
        </div>
